...
* Käyttäjä pystyy valitsemaan paikalle yhden tai useamman luokittelun (esim. Ruokaa tarjolla, ikärajaton)
* Käyttäjä pystyy antamaan katselupaikalle sanallisen arvostelun ja tähtiarvosanan (1-5). Paikan tiedoissa näytetään kaikki arvostelut ja niiden keskiarvo.
